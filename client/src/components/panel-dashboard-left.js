      ...
      <div class="col-2 panelDashboard1"> 
        ...
        <div class="row">
          <div class="col">   
            ...
            {this.props.user.isOwner?<div class="title">(<Link to={'/profile/image/'+this.props.user.userid}><Trans i18nKey='profile:view.update'>update image</Trans></Link>)</div>:""}
          </div>
        </div>   
        <div class="row">
          <div class="col leftLinks">
            <ul>
              {this.props.user.isOwner?<li className={`${this.props.page === 'editprofile'?"sel":""}`}><Link to={'/profile/edit/'+this.props.user.userid}><Trans i18nKey='profile:view.edit'>edit profile</Trans></Link></li>:""}
